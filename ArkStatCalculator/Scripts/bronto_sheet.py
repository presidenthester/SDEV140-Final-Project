...
def brontopage():
    ...
    brontoCalc.title("Ark Wild Dino Stat Calculator -- Brontosaurus")
    ...
    brontoImg = ImageTk.PhotoImage(file="C:\FinalProject\ArkStatCalculator\Images\\brontosaurus.png")

    # Canvas setup

    ankCanvas = Canvas(brontoCalc, width=480, height=540, bg="#439BEB")
    ankCanvas.pack(fill="both", expand=True)
    ankCanvas.create_image(480,10, anchor="n", image=brontoImg)
    ankCanvas.create_text(480, 325, text="Brontosaurus", font= ("Copperplate Gothic Bold", "40") ,fill="#EB9443")
    ...
    healthEntry = Label(brontoCalc, width=6,bd=1, text=2070, font=("Copperplate Gothic Bold", "24"))
     
    stamEntry = Label(brontoCalc, width=6,bd=1, text=240, font=("Copperplate Gothic Bold", "24"))
   
    oxyEntry = Label(brontoCalc, width=6,bd=1, text=150, font=("Copperplate Gothic Bold", "24"))
    
    foodEntry = Label(brontoCalc, width=6,bd=1,text=10000, font=("Copperplate Gothic Bold", "24"))
     
    weightEntry = Label(brontoCalc, width=6,bd=1,text=1600, font=("Copperplate Gothic Bold", "24"))
    ...
    torporEntry = Label(brontoCalc, width=6,bd=1,text=2000.0, font=("Copperplate Gothic Bold", "24"))
