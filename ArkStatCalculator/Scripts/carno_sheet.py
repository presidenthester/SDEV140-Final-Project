...
def carnoPage():
    ...
    brontoCalc.title("Ark Wild Dino Stat Calculator -- Carnotaurus")
    ...
    carnoImg = ImageTk.PhotoImage(file="C:\FinalProject\ArkStatCalculator\Images\carnotaurus.png")

    # Canvas setup

    ankCanvas = Canvas(brontoCalc, width=480, height=540, bg="#439BEB")
    ankCanvas.pack(fill="both", expand=True)
    ankCanvas.create_image(480,10, anchor="n", image=carnoImg)
    ankCanvas.create_text(480, 325, text="Carnotaurus", font= ("Copperplate Gothic Bold", "40") ,fill="#EB9443")
    ...
    healthEntry = Label(brontoCalc, width=6,bd=1, text=420, font=("Copperplate Gothic Bold", "24"))
    ...
    foodEntry = Label(brontoCalc, width=6,bd=1,text=2000, font=("Copperplate Gothic Bold", "24"))
     
    weightEntry = Label(brontoCalc, width=6,bd=1,text=300, font=("Copperplate Gothic Bold", "24"))
    ...
    torporEntry = Label(brontoCalc, width=6,bd=1,text= 350.0, font=("Copperplate Gothic Bold", "24"))
