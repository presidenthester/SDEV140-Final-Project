...
def gigaPage():
    ...
    brontoCalc.title("Ark Wild Dino Stat Calculator -- Giganotosaurus")
    ...
    gigaImg = ImageTk.PhotoImage(file="C:\FinalProject\ArkStatCalculator\Images\giganotosaurus.png")

    # Canvas setup

    ankCanvas = Canvas(brontoCalc, width=480, height=540, bg="#439BEB")
    ankCanvas.pack(fill="both", expand=True)
    ankCanvas.create_image(480,10, anchor="n", image=gigaImg)
    ankCanvas.create_text(480, 325, text="Giganotosaurus", font= ("Copperplate Gothic Bold", "40") ,fill="#EB9443")
    ...
    healthEntry = Label(brontoCalc, width=6,bd=1, text=80000, font=("Copperplate Gothic Bold", "24"))
     
    stamEntry = Label(brontoCalc, width=6,bd=1, text=400, font=("Copperplate Gothic Bold", "24"))
   
    oxyEntry = Label(brontoCalc, width=6,bd=1, text=150, font=("Copperplate Gothic Bold", "24"))
    
    foodEntry = Label(brontoCalc, width=6,bd=1,text=4000, font=("Copperplate Gothic Bold", "24"))
     
    weightEntry = Label(brontoCalc, width=6,bd=1,text=700, font=("Copperplate Gothic Bold", "24"))
    ...
    torporEntry = Label(brontoCalc, width=6,bd=1,text= 10000.0, font=("Copperplate Gothic Bold", "24"))
    ...
    def up_stam():
        ...
        stamStatPoint += 1
        dinoLevel += 1
        stamEntry.config(text="{:.2f}".format(stam))
    ...
    def up_oxy():
        ...
        oxyStatPoint += 1
        dinoLevel += 1
        oxyEntry.config(text="{:.2f}".format(oxy))
