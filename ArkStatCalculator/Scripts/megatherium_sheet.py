...
def megatheriumPage():
    ...
    brontoCalc.title("Ark Wild Dino Stat Calculator -- Megatherium")
    ...
    megatheriumImg = ImageTk.PhotoImage(file="C:\FinalProject\ArkStatCalculator\Images\megatherium.png")

    # Canvas setup

    ankCanvas = Canvas(brontoCalc, width=480, height=540, bg="#439BEB")
    ankCanvas.pack(fill="both", expand=True)
    ankCanvas.create_image(480,10, anchor="n", image=megatheriumImg)
    ankCanvas.create_text(480, 325, text="Megatherium", font= ("Copperplate Gothic Bold", "40") ,fill="#EB9443")
    ...
    healthEntry = Label(brontoCalc, width=6,bd=1, text=740, font=("Copperplate Gothic Bold", "24"))
     
    stamEntry = Label(brontoCalc, width=6,bd=1, text=400, font=("Copperplate Gothic Bold", "24"))
   
    oxyEntry = Label(brontoCalc, width=6,bd=1, text=270, font=("Copperplate Gothic Bold", "24"))
    
    foodEntry = Label(brontoCalc, width=6,bd=1,text=3000, font=("Copperplate Gothic Bold", "24"))
     
    weightEntry = Label(brontoCalc, width=6,bd=1,text=725, font=("Copperplate Gothic Bold", "24"))
    ...
    torporEntry = Label(brontoCalc, width=6,bd=1,text= 1000.0, font=("Copperplate Gothic Bold", "24"))
