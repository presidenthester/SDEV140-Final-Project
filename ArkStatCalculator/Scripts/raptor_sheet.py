...
def raptorPage():
    ...
    brontoCalc.title("Ark Wild Dino Stat Calculator -- Raptor")
    ...
    raptorImg = ImageTk.PhotoImage(file="C:\FinalProject\ArkStatCalculator\Images\\raptor.png")

    # Canvas setup

    ankCanvas = Canvas(brontoCalc, width=480, height=540, bg="#439BEB")
    ankCanvas.pack(fill="both", expand=True)
    ankCanvas.create_image(480,10, anchor="n", image=raptorImg)
    ankCanvas.create_text(480, 325, text="Raptor", font= ("Copperplate Gothic Bold", "40") ,fill="#EB9443")
    ...
    healthEntry = Label(brontoCalc, width=6,bd=1, text=200, font=("Copperplate Gothic Bold", "24"))
     
    stamEntry = Label(brontoCalc, width=6,bd=1, text=150, font=("Copperplate Gothic Bold", "24"))
   
    oxyEntry = Label(brontoCalc, width=6,bd=1, text=150, font=("Copperplate Gothic Bold", "24"))
    
    foodEntry = Label(brontoCalc, width=6,bd=1,text=1200, font=("Copperplate Gothic Bold", "24"))
     
    weightEntry = Label(brontoCalc, width=6,bd=1,text=140, font=("Copperplate Gothic Bold", "24"))
    ...
    torporEntry = Label(brontoCalc, width=6,bd=1,text= 180.0, font=("Copperplate Gothic Bold", "24"))
    ...
    def up_weight():
        ...
        weightStatPoint += 1
        dinoLevel += 1
        weightEntry.config(text="{:.2f}".format(weight))
