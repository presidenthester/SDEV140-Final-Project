...
def rexPage():
    ...
    brontoCalc.title("Ark Wild Dino Stat Calculator -- Rex")
    ...
    rexImg = ImageTk.PhotoImage(file="C:\FinalProject\ArkStatCalculator\Images\\rex.png")

    # Canvas setup

    ankCanvas = Canvas(brontoCalc, width=480, height=540, bg="#439BEB")
    ankCanvas.pack(fill="both", expand=True)
    ankCanvas.create_image(480,10, anchor="n", image=rexImg)
    ankCanvas.create_text(480, 325, text="Rex", font= ("Copperplate Gothic Bold", "40") ,fill="#EB9443")
