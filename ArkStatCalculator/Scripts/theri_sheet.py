...
def theriPage():
    ...
    brontoCalc.title("Ark Wild Dino Stat Calculator -- Therizinosaurus")
    ...
    theriImg = ImageTk.PhotoImage(file="C:\FinalProject\ArkStatCalculator\Images\\therizinosaurus.png")

    # Canvas setup

    ankCanvas = Canvas(brontoCalc, width=480, height=540, bg="#439BEB")
    ankCanvas.pack(fill="both", expand=True)
    ankCanvas.create_image(480,10, anchor="n", image=theriImg)
    ankCanvas.create_text(480, 325, text="Therizinosaurus", font= ("Copperplate Gothic Bold", "40") ,fill="#EB9443")
    ...
    healthEntry = Label(brontoCalc, width=6,bd=1, text=870, font=("Copperplate Gothic Bold", "24"))
     
    stamEntry = Label(brontoCalc, width=6,bd=1, text=300, font=("Copperplate Gothic Bold", "24"))
    ...
    weightEntry = Label(brontoCalc, width=6,bd=1,text=365, font=("Copperplate Gothic Bold", "24"))
    ...
    torporEntry = Label(brontoCalc, width=6,bd=1,text= 925.0, font=("Copperplate Gothic Bold", "24"))
    ...
    def down_weight():
        ...
        weightStatLab.config(text="{:.2f}".format(weight))
        if weight < 365:
            weight = 365
            weightEntry.config(text=weight)
        if weightStatPoint < 0:
